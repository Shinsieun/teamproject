      ...
      <div class="row content">
         ...
         <div class="col-sm-8 text-left">
            <h1>Add New Employee</h1>
             <form:form method="post" action="save_2">
               <table>
                  <tr>
                     <td>mon :</td>
                     <td><form:input path="mon" /></td>
                  
                  <tr>
                     <td>tue :</td>
                     <td><form:input path="tue" /></td>
                  </tr>
                  <tr>
                     <td>wed :</td>
                     <td><form:input path="wed" /></td>
                  </tr>
                  <tr>
                     <td>tur :</td>
                     <td><form:input path="tur" /></td>
                  </tr>
                  <tr>
                     <td>fri :</td>
                     <td><form:input path="fri" /></td>
                  </tr>
                  <tr>
                     <td>time :</td>
                  ...
                  <tr>
                     <td></td>
                     <td><input type="submit" value="Save_2" /></td>
                  </tr>
               </table>
            </form:form>
